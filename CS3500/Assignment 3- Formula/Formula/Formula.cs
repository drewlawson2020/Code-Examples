...
namespace SpreadsheetUtilities
{
    ...
    public class Formula
    {
        ...
        /// <summary>
        /// Verifies if the variable is valid through regex. It checks for a number of chars from a-z and A-Z, and then at least 1 or more digits. 
        /// </summary>
        /// <param name="token"></param>
        /// <returns>Returns true if formatted correctly, false otherwise.</returns>
        private static Boolean Is_var(String token)
        {
