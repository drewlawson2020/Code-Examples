...
/// File Contents
/// 
/// File used to initialize a ChatServerGUI and add the CustomFileLogger to services to allow for dependency injection.
/// 
///</summary>
...
namespace ChatServer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                var gui = serviceProvider.GetRequiredService<ChatServerGUI>();
                Application.Run(gui);
            }
        }
    }
